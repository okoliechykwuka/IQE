...
design_resources = {
    ...
    "arches_and_spaces": [
     ...
     # TRANSFER
transfer_resources = {"action_mapping": [
   ...
   # Performance
performance_resources = {"mager_and_Pipe": [
    ...
    "addie": [
        "https://research.com/education/the-addie-model#applications"
    ],
